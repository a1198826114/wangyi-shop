      ...
      <div class="nav">
        ...
        <div class="right">
          ...
          <div class="rule">
            ...
            <span>排行规则</span>
            <ul>
              <li>此榜单包含5首歌曲及以上的迷你专辑和完整专辑，按照售卖张数排名，专辑内单曲购买的数据不在统计范围，榜单30分钟更新一次。</li>
              <li>日榜：网易云音乐当日销售量最高的50张数字专辑，按照售卖张数排名，每日0点清空昨日数据，名次变化与昨日相比，榜单30分钟更新一次，只统计当前在售的数字专辑。</li>
              <li>周榜：网易云音乐本周销售量最高的50张数字专辑，按照售卖张数排名。名次变化与上周相比，榜单30分钟更新一次，只统计当前在售的数字专辑。</li>
              <li>年榜：网易云音乐所有数字专辑在当年度1月1日00:00—12月31日24:00所产生的销售量，只展示销售量排名最高的50张数字专辑，按照售卖张数排名，榜单30分钟更新一次。进入下一年度后，上个年度榜单会作为历史数据保留。</li>
              <li>总榜：网易云音乐销量最高的50张数字专辑，按照售卖张数排名，榜单30分钟更新一次。</li>
            </ul>
          </div>
        </div>
      </div>
